 ...
 */
class Version20180424175725 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE partida CHANGE campeonatos_id campeonato_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE partida CHANGE campeonato_id campeonatos_id INT DEFAULT NULL');
